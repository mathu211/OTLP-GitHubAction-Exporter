...
def parse_attributes(obj,att_to_drop,otype):
    ...
    attributes_to_drop = []
    # todo
    # if "GITHUB_ATTRIBUTES_DROP" in os.environ:
    #     try:
    #         if os.getenv("GITHUB_ATTRIBUTES_DROP") != "":
    #             user_attributes_to_drop =str(os.getenv("GITHUB_ATTRIBUTES_DROP")).lower().split(",")
                            ...
                            if type(obj[attribute][sub_att]) is dict:                                
                                for att in obj[attribute][sub_att]:                                                                  
                                    ...
                                    if attribute_name not in attributes_to_drop:                                         
                                        ...
                                        print("Check string: ", obj[attribute][sub_att])                                     
                                        if attribute_name.endswith("_at"):        
                                            print("confirmed")                                     
                                            if obj['conclusion'] == 'skipped' or obj['conclusion'] == 'cancelled':                                                    
                                                pass
                                ...
                                print("List found in attribute: ", attribute)
